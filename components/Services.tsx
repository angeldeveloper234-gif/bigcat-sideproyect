      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl">
            <span className="inline-block py-1 px-4 rounded-full bg-brand-red/10 text-brand-red font-normal tracking-widest uppercase text-[10px] mb-6 border border-brand-red/20">
              Silos de Especialización
            </span>
            <h2 className="text-4xl lg:text-6xl font-normal text-brand-dark tracking-tighter leading-[0.9]">
              Nuestras <span className="text-brand-red">Soluciones</span> <br /> 
              Certificadas FE™
            </h2>
          </div>
          <p className="text-xl text-gray-500 font-normal max-w-sm md:text-right leading-relaxed">
                ...
                <div className="relative z-10 flex flex-col h-full">
                    <div className="flex justify-between items-start mb-10">
                        ...
                        {pest.id === 'control-comercial' && (
                            <span className="bg-gradient-to-r from-red-600 to-red-500 text-white text-[10px] font-normal uppercase tracking-widest py-1.5 px-3 rounded-full shadow-lg shadow-red-500/30 animate-pulse">
                                Más Solicitado
                            </span>
                        )}
                    </div>
                    ...
                    <div className="space-y-6 flex-grow">
                        <h3 className="font-normal text-3xl leading-tight text-brand-dark">{pest.name}</h3>
                        ...
                        <div className="flex flex-wrap gap-2 pt-4">
                            {pest.features.slice(0, 2).map((f, i) => (
                                <span key={i} className="text-[10px] font-normal uppercase tracking-widest bg-gray-100 text-gray-500 px-3 py-1.5 rounded-full">
                                    {f}
                                </span>
                            ))}
                        </div>
        ...
        <div className="mt-20 bg-brand-dark rounded-[3rem] p-12 flex flex-col lg:flex-row items-center justify-between gap-12 shadow-3xl text-white overflow-hidden relative">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                    <p className="font-normal text-2xl leading-none">Sector Comercial</p>
                    <p className="text-gray-400 text-sm mt-1 font-normal italic tracking-wide">+300 Restaurantes Protegidos</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                    <p className="font-normal text-2xl leading-none">Sector Residencial</p>
                    <p className="text-gray-400 text-sm mt-1 font-normal italic tracking-wide">Privacidad & Garantía Total</p>
                    </div>
                </div>
            </div>
