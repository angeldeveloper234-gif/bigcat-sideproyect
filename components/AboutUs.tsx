            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="relative rounded-[3rem] overflow-hidden shadow-3xl group">
                            ...
                            <div className="absolute bottom-8 left-8 right-8">
                                <div className="bg-brand-red p-8 rounded-3xl shadow-2xl transform transition-transform group-hover:-translate-y-2">
                                    <p className="text-white text-xl font-normal leading-tight uppercase tracking-tight italic">
                        ...
                        <div className="absolute -top-10 -right-6 bg-brand-dark p-10 rounded-[2.5rem] shadow-3xl animate-float border border-white/10 group">
                            <div className="relative">
                                <p className="text-brand-red font-semibold text-6xl leading-none">29+</p>
                                <p className="text-white font-medium text-xs uppercase tracking-[0.2em] mt-3">Años de <br/>Experiencia Real</p>
                    ...
                    <div className="w-full lg:w-1/2 space-y-12">
                        <div>
                            <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-brand-red/10 text-brand-red font-medium tracking-[0.2em] uppercase text-[10px] mb-6 border border-brand-red/20">
                                <ShieldCheck size={14} /> Elite Pest Protection
                            </span>
                            <h2 className="text-4xl lg:text-6xl font-semibold text-brand-dark tracking-tighter leading-[0.9] mb-8">
                            ...
                            <p className="text-xl text-gray-500 font-normal leading-relaxed max-w-xl">
                                Desde 1995, <span className="text-brand-dark font-medium">Big Cat - Control de plagas</span> (parte de la familia <span className="text-brand-dark font-medium">PCP Internacional</span>) ha liderado el control de plagas en México con soluciones eficaces, asequibles y personalizadas.
                            </p>
                            <p className="text-lg text-gray-500 font-normal leading-relaxed max-w-xl mt-4">
                                Nos comprometemos con la seguridad total: utilizamos <span className="text-brand-dark font-medium">productos 100% seguros para personas y mascotas</span> que no afectan el medio ambiente, garantizando resultados definitivos con un respaldo técnico de más de 29 años.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={idx} className="group p-4 bg-brand-gray/50 rounded-2xl border border-transparent hover:border-brand-red/20 hover:bg-white hover:shadow-xl transition-all duration-500 flex flex-col items-center text-center">
                                    ...
                                    <h4 className="font-semibold text-xs text-brand-dark uppercase tracking-wider">{sector.label}</h4>
                                </div>
                            ))}
                        </div>
                        
                        <p className="text-sm text-gray-400 font-normal italic leading-relaxed">
                        ...
                        <div className="pt-8 block">
                            <a 
                                href="#contacto" 
                                className="inline-flex items-center gap-4 bg-brand-dark text-white px-10 py-5 rounded-2xl font-semibold text-sm uppercase tracking-[0.2em] hover:bg-brand-red transition-all shadow-2xl hover:shadow-brand-red/30 group/btn"
                            >
