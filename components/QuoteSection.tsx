            ...
            >
              ...
              <p className="text-xl text-gray-500 font-medium leading-relaxed max-w-lg">
                ...
                <div className="grid grid-cols-2 gap-6 pb-4">
                   <div className="space-y-2">
                      ...
                      <p className="text-xs font-black text-brand-dark uppercase tracking-widest">Protección Total</p>
                      <p className="text-[10px] text-gray-400 font-bold uppercase">Respaldo Profesional</p>
                   </div>
                   <div className="space-y-2">
                      <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center border border-gray-100">
                        <Zap className="text-brand-red" size={20} />
                      </div>
                      <p className="text-xs font-black text-brand-dark uppercase tracking-widest">Atención Express</p>
                      <p className="text-[10px] text-gray-400 font-bold uppercase">Respuesta <br />Inmediata</p>
                   </div>
                </div>
                ...
                <div className="p-6 bg-white border border-gray-100 rounded-[2rem] shadow-sm flex items-center gap-6">
                    ...
                    <div>
                       <p className="text-sm font-black text-brand-dark">+1,200 Hogares Protegidos</p>
                       <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Este mes en México</p>
                    </div>
                </div>
              </div>
              ...
              >
                <div className="bg-white rounded-[3rem] p-10 lg:p-12 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] border border-gray-100 relative group overflow-hidden">
                    ...
                    <div className="mb-8">
                        <h3 className="text-3xl font-black text-brand-dark tracking-tighter mb-2">Cotización Residencial</h3>
                        <p className="text-sm text-gray-400 font-bold uppercase tracking-widest">Servicio 100% libre de olores</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-4">
                            <input
                                ...
                                required
                                className="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:border-brand-red outline-none transition-all font-medium"
                            ...
                            <select 
                                required
                                className="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:border-brand-red outline-none transition-all font-medium text-gray-500"
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:border-brand-red outline-none transition-all font-medium resize-none"
                        ...
                        <button
                            type="submit"
                            className="w-full py-6 rounded-2xl bg-brand-red text-white font-black text-lg uppercase tracking-widest hover:bg-brand-dark transition-all duration-500 shadow-xl shadow-brand-red/20 group/btn"
                        >
                        ...
                        <div className="mt-8 pt-8 border-t border-gray-50 flex items-center justify-between opacity-50">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest leading-none">Datos Seguros</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle size={14} className="text-green-500" />
                                <span className="text-[10px] font-black uppercase tracking-widest leading-none">Evaluación Profesional</span>
                            </div>
                        </div>
                </form>
            </div>
